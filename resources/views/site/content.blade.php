        ...
        <div class="container">
            ...
            <div class="service_wrapper">
                @foreach($services as $k=>$service)
                    @if($k == 0 || $k%3 == 0)
{{--                        {{dd($k.'-'.$service)}}--}}
                       <div class="row {{($k != 0) ? 'borderTop' : '' }}">   {{--  тернарный оператор--}}
                    @endif

                            <div class="col-lg-4 {{ ($k != 0 && $k != 3 && $k !=6) ? 'borderLeft' : '' }} {{($k > 2) ? 'mrgTop' : ''}}">
...
<footer class="footer_wrapper" id="contact">
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright © 2014,    Template by <a href="http://webthemez.com">Ali.com</a>. </span> </div>
    </div>
</footer>