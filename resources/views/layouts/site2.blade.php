    ...
    <div class="container">
        <nav class="navbar navbar-inverse" role="navigation">
            <div class="navbar-header">
                ...
                <a href="#" class="navbar-brand scroll-top logo  animated bounceInLeft"><b><i>TIMES</i></b></a> </div>
            <!--/.navbar-header-->
    ...
    <div class="banner-container"> <img src="images/banner-bg.jpg" alt="banner" />
        <div class="container banner-content">
            <div class="hero-text animated fadeInDownBig">
                <h1 class="responsive-headline" style="font-size: 40px;">Times - Bootstrap Responsive<br/>
                    Template  for your Business or Corporate</h1>
...
<section class="copyright">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center"> Copyright 2019 | All Rights Reserved - <a href="https://webthemez.com/tag/free" target="_blank">Free Website Templates</a> by WebThemez.com.</div>
        </div>
        <!-- / .row -->
    </div>
</section>
